...
exports.upsertUserSocialMedia = void 0;
const user_model_1 = __importDefault(require("../../models/user.model"));
const generate = __importStar(require("../../helpers/generate"));
const upsertUserSocialMedia = (res, typeAcc, dataRaw) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let user = null;
...
exports.upsertUserSocialMedia = upsertUserSocialMedia;
